...
export function ArchitectureExplorer() {
    ...
    return (
        <section id="structure" className="py-24 relative overflow-hidden bg-tech-black min-h-[100vh]">
            {/* Background */}
            ...
            <div className="container relative z-10 px-4">
                ...
                <div className="text-center mb-16">
                    <h2 className="text-5xl md:text-7xl font-space font-bold mb-6 uppercase text-white">
