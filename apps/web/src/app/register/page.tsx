            ...
            >
                ...
                <div className="text-center mb-8">
                    <Link href="/" className="inline-flex items-center gap-2 mb-4 hover:opacity-80 transition-opacity">
                        <div className="p-2 border border-white/10 bg-black/50">
                            <Terminal className="w-6 h-6 text-tech-purple" />
                        </div>
                    ...
                    <h1 className="text-3xl font-space font-bold uppercase tracking-tight mb-2 text-white">
                        Access <span className="text-tech-purple">Request</span>
                    </h1>
                ...
                <div className="bg-tech-gray/20 backdrop-blur-xl border border-white/10 p-8 relative overflow-hidden group">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group/input">
                                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground group-focus-within/input:text-tech-purple transition-colors" />
                                <input
                                    type="email"
                                    value={email}
                                    onChange={(e) => setEmail(e.target.value)}
                                    placeholder="operator@kybernus.io"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group/input">
                                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground group-focus-within/input:text-tech-purple transition-colors" />
                                <input
                                    type="password"
                                    value={password}
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-4 bg-tech-purple text-white font-mono font-bold uppercase tracking-widest text-xs hover:bg-white hover:text-black hover:border-white border border-transparent transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
                            {loading ? (
                    ...
                    <div className="mt-6 pt-6 border-t border-white/5 text-center flex flex-col gap-2">
                        ...
                        <Link href="/login" className="text-xs font-mono font-bold uppercase tracking-wider text-white hover:text-tech-purple transition-colors inline-block">
                            // ENTER TERMINAL
                        </Link>
                    </div>
                </div>
